...
export declare type onSelectMessage = {
    message?: {
        order: {
            provider?: Provider;
            provider_location?: Location;
...
export declare type onInitMessage = {
    message?: {
        order: {
            provider?: {
                id?: string;
...
export declare type ONDCOptions = {
    host: string;
    apiKey?: string;
    bapId: string;
    bapUri: string;
...
export declare type SubscriberDetail = {
...
export declare type Action = "search" | "select" | "init" | "confirm" | "update" | "status" | "track" | "cancel" | "rating" | "support" | "on_search" | "on_select" | "on_init" | "on_confirm" | "on_update" | "on_status" | "on_track" | "on_cancel" | "on_rating" | "on_support";
...
export declare type ItemQuantitySub = {
    count?: number;
    measure?: Scalar;
};
...
export declare type Agent = Person & Contact & {
    rateable?: Rateable;
};
...
export declare type DecimalValue = string;
...
export declare type FeedbackForm = FeedbackFormElement[];
...
export declare type Gps = string;
...
export declare type Operator = Person & {
    experience?: {
        label?: string;
        value?: string;
        unit?: string;
...
export declare type Rateable = boolean;
...
export declare type TrackingData = Gps;
